...
$( document ).ready(function() {
	...
	function loadImage() {
		...
		img.onload = function () {
			//$( '#swiperSlide_' + (index-1)).clone().insertAfter('#swiperSlide_' + (index-1) ).prop('id', 'swiperSlide_' + index);
			//$( '#transClick_' + (index)).clone().insertAfter('#transClick_' + index ).prop('id', 'transClick_' + (index + 1));
